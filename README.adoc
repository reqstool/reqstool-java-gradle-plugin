...
Gradle plugin for assembling and attaching reqstool ZIP artifacts. This plugin mimics the behavior of the link:https://github.com/reqstool/reqstool-java-maven-plugin[reqstool-java-maven-plugin].
